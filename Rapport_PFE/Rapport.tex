...
Les fonctions suivantes : \textit{changetoLW(), send_datatoLWGW(s,recolte), changetoLora(lora)} change la manière de communiqué de la LoRaGateway: soit en LoRa, soit en LoRaWAN, et bien entendu la fonction send, s'occupe de formater la chaine donné en bytes et de l'envoyer.
